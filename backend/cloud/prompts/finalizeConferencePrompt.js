...
const FINALIZE_CONFERENCE_PROMPT_VERSION = '1.0.0';
...
The trainee has finished gathering information for this preoperative cardiac surgery case. Produce the report they need to present and discuss it at conference. Each section may be written as prose or as an array of short bullet strings -- pick whichever reads more clearly for that section's content, no need to force a consistent shape across sections.

Generate exactly these sections:

1. "diagnosis": the working cardiac diagnosis.
2. "indication": why surgery is indicated for this patient.
...
5. "alternatives": other reasonable approaches (medical management, a different operation, a different technique) and why the planned strategy was chosen over them.
6. "controversies": where reasonable, well-informed surgeons might disagree about this case's management.
