 ...
 * prompts/correctDictationPrompt.js. Shared by both workflows since it
 * operates on raw dictated text before either workflow's own AI sees it.
 */
...
const { validateCorrectDictationResponse } = require('../schemas/dictationResponseSchema');
