...
//  Welcome screen or the signed-in app is shown, and the loading state
//  while the persisted Parse session is being checked at launch.
//
...
enum AuthenticationState: Equatable {
    ...
    /// on the signed-in app during the network call or cutting straight
    /// to Welcome. See `AuthenticationViewModel.signOut()`/`deleteAccount()`.
    case endingSession
    case signedOut
