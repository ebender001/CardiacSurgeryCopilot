...
//  owner. Used identically by the case-intake narrative
//  (ConferenceIntakeViewModel) and interview-answer
//  (ConferenceInterviewViewModel) dictation flows -- see DictationEditorView
//  for the matching shared UI.
//
