    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            VStack(alignment: .leading, spacing: 6) {
                ...
                Text("Start with a brief case summary. Cardiac Surgery Copilot will help you clarify the details and prepare a structured report for the heart team conference.")
                    .font(.footnote)
